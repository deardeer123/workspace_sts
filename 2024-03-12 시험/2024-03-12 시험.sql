...
CREATE TABLE sales_info(
  SALES_NUM INT AUTO_INCREMENT ,
  BUYER VARCHAR(50) NOT NULL ,
  TEL VARCHAR(50) ,
  COLOR VARCHAR(50) NOT NULL ,
  SALES_DATE DATETIME DEFAULT CURRENT_TIMESTAMP ,
  CAR_NUM not null INT ,
  CONSTRAINT SALES_NUM_PK PRIMARY KEY(SALES_NUM) ,
  CONSTRAINT CAR_SALES_PK FOREIGN KEY (CAR_NUM) REFERENCES car_info(CAR_NUM) ON DELETE CASCADE
);

SELECT * FROM car_info;
SELECT * FROM sales_info;

INSERT INTO car_info VALUES(1, 'a' , 10000, 'kor');
INSERT INTO car_info VALUES(2, 'aa' , 20000, 'kor');
